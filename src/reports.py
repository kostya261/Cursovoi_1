...
def spending_by_category(data_frame: pd.DataFrame, category: str, start_date: Optional[str] = None) -> pd.DataFrame:
    """
    ...
    try:
        ...
        result = filtered_df[filtered_df["Категория"].str.contains(category, case=False, na=False)]
